import { onFormatDataGameConfig } from "components/games/Mtc/selection";
import React, { useState, useEffect, useRef } from "react";
import socketIOClient from "socket.io-client";
import "./App.css";
import DragAndDropImageContainer from "./components/games/Dnd/DragAndDropImageContainer";
import MultipleChoice from "./components/games/Mtc/DoingExercise";
...
function App() {
  ...
  let data = {
    ...
    icon_list: [
      {
        ...
        icons: [
          {
            icon_id: "Truong.Test.Mix.Game.1_1",
            path: "",
            type_media: 1,
            props: [],
            tracing: '""',
          ...
          {
            icon_id: "Truong.Test.Mix.Game.1Q",
            path: "",
            type_media: 1,
            props: [
              {
                key: "name_1",
                text: "Số liền sau của 76 là:",
                audio: [
                  {
                    path: "",
                    voice_id: 56,
          ...
          {
            icon_id: "Truong.Test.Mix.Game.1.1",
            path: "",
            type_media: 1,
            props: [
              {
          ...
          {
            icon_id: "Truong.Test.Mix.Game.1.2",
            path: "",
            type_media: 1,
            props: [
              {
          ...
          {
            icon_id: "Truong.Test.Mix.Game.1.3",
            path: "",
            type_media: 1,
            props: [
              {
          ...
          {
            icon_id: "Truong.Test.Mix.Game.1.4",
            path: "",
            type_media: 1,
            props: [
              {
    ...
    game_config: {
      ...
      type_question: ["text"],
      type_answer: ["text"],
      answer_number_in_a_row: "",
      back_ground: {
        icon_id: "Truong.Test.Mix.Game.1_1",
      },
      data: [
        {
          question: "Truong.Test.Mix.Game.1Q",
          answer_number_in_a_row: 4,
          answers: [
            {
              answer_id: "Truong.Test.Mix.Game.1.1",
            },
            {
              answer_id: "Truong.Test.Mix.Game.1.2",
            },
            {
              answer_id: "Truong.Test.Mix.Game.1.3",
              is_correct: true,
            },
            {
              answer_id: "Truong.Test.Mix.Game.1.4",
            },
          ],
        },
      ],
  ...
  return (
    <>
      <DragAndDropImageContainer data={data2}></DragAndDropImageContainer>
