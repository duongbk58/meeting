...
import EraserAll from "./eraser-all";
import Text from "./text";
import Link from "./link";
import DefaultTool from "./defaul-tool";
import HideOfPart from "./hide-of-part";
import IsoPartOfScreen from "./isolate-part-of-screen";
...
class SketchField extends PureComponent {
  ...
  _initTools = (fabricCanvas) => {
    ...
    this._tools[Tools.Highlight] = new Highlight(fabricCanvas);
    ...
    this._tools[Tools.HideOfPart] = new HideOfPart(fabricCanvas);
    this._tools[Tools.IsoPartOfScreen] = new IsoPartOfScreen(fabricCanvas);
    ...
    this._tools[Tools.DottedLine] = new DottedLine(fabricCanvas);
    this._tools[Tools.Eraser] = new Eraser(fabricCanvas);
    this._tools[Tools.EraserAll] = new EraserAll(fabricCanvas);
    this._tools[Tools.Text] = new Text(fabricCanvas);
    this._tools[Tools.Link] = new Link(fabricCanvas);
